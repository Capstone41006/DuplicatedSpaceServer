...
if __name__ == '__main__':
    ...
    output_colmap_path=img_folder_path.replace("images", "sparse/0")                                    #### 중요 - Dust3r 출력1 ####
    ...
    # save
    save_colmap_cameras(ori_size, intrinsics, os.path.join(output_colmap_path, 'cameras.txt'))          ### 중요 - Dust3r 출력2 ####
